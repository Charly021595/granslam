    ...
    <div class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="jugadores.php" class="nav-link active">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="p-2">
              <button id="DescargarGafet" class="btn btn-primary float-right botones_qr botones_iguales" onclick="GenerarGafet()"><label id="lbl_gafet">Descargar gafet</label><img id="cargando_gafet" class="cargando_boton" src="../assets/img/loading.gif" style="display:none;"></button>
              <button id="DescargarArchivoPDF" class="btn btn-primary float-right botones_qr botones_iguales" onclick="GenerarPDF()"><label id="lbl_pdf">Descargar PDF</label><img id="cargando_pdf" class="cargando_boton" src="../assets/img/loading.gif" style="display:none;"></button>
              <button id="crear_partido" class="btn btn-primary float-right botones_qr botones_iguales" data-toggle="modal" data-target="#nuevo_jugador">Crear Nuevo Jugador</button>
              <button id="crear_qr" class="btn btn-primary float-right botones_qr botones_iguales" style="display:none;"><label id="lbl_crear_qr">Generar Codigos QR</label><img id="cargando_qr" class="cargando_boton" src="../assets/img/loading.gif" style="display:none;"></button>
            </div>
          </div>
        </div>
        <!-- qr oculto -->
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header bg-success centrar_texto">Listado Jugadores</div>
              <div class="card-body">
                <div class="row" id="cargando_tabla">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 centrar_texto">
                    <img id="cargando_tabla_jugadores" class="cargando_tablas" src="../assets/img/loading.gif">
                  </div>
                </div>
                <div class="row" id="mostrar_jugadores" style="display:none;">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <table id="tabla_jugadores" class="table table-hover table-bordered 
                    ...
                    table-responsive-lg table-responsive-xl table-responsive-xxl" style="width:100%;">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Foto Jugador</th>
                          <th scope="col">QR Jugador</th>
              ...
              <div class="modal-body">
                ...
                <div id="div_manual">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-6">
                      <input type="text" name="add_apellidoM" id="add_apellidoM" onchange="add_qrcode()" placeholder="Apellido Materno" class="form-control">
                    </div>
                  </div>
...
<!-- mis js -->
<script src="../assets/js/jugadores.js?t=<?=time()?>"></script>
</body>
</html>
