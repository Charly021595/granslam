    ...
    <div class="sidebar color_fratech">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="view/check_user.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="view/jugadores.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="view/listado_premiacion.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="view/juegos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="view/eventos.php" class="nav-link">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header bg-success">Todos los Eventos</div>
              <div class="card-body">
                <div class="row" id="cargando_tabla">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 centrar_texto">
                    <img id="cargando_tabla_eventos" class="cargando_tablas" src="assets/img/loading.gif">
                  </div>
                </div>
                <div class="row" id="mostrar_eventos" style="display:none;">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <table id="tabla_eventos" class="table table-hover table-bordered 
